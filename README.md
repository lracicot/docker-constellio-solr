...
This image is a distribution of Solr configured to work with the [Constellio](https://constellio.com/) software.

The Docker image for Constellio can be found at https://github.com/lracicot/docker-constellio
